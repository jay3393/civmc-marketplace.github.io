      ...
      <div className="relative container mx-auto px-4 py-16">
        ...
        <div className="mt-14 flex justify-center">
          <div className="relative w-full max-w-4xl">
            <div className="relative rounded-xl border bg-background/70 backdrop-blur shadow-xl overflow-hidden transform perspective-[1200px] rotate-x-[6deg] rotate-y-[12deg]">
              ...
              <div className="aspect-[16/9] w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 grid place-items-center text-slate-200">
                <img src="https://iili.io/FpVPr1R.png" alt="Sneak peek image" className="w-full h-full object-cover" />
              </div>
            </div>
            {/* Subtle glow under the card */}
            <div className="absolute inset-x-10 -bottom-5 h-10 bg-blue-500/30 blur-2xl"/>
          </div>
        </div>
      </div>
    </div>
